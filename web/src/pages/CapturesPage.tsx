      ...
      <div className="bg-[var(--bg-surface)] border border-[var(--border-hairline)] rounded-xl p-4 mb-8">
        ...
        <form onSubmit={handleAdd} className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              type="submit"
              className="shrink-0 bg-[var(--text-primary)] text-[var(--bg-base)] px-4 py-2 rounded text-sm font-medium hover:opacity-90 flex items-center justify-center gap-2"
            >
      ...
      <div className="space-y-3">
        {captures.length === 0 ? (
          ...
          captures.map((c) => (
            <div
              key={c.id}
              className="p-4 border border-[var(--border-hairline)] rounded-lg flex items-start justify-between gap-4 bg-[var(--bg-surface)]"
            >
              ...
              <button
                ...
                className="p-2 text-[var(--text-secondary)] hover:text-red-500 transition-colors mt-4"
              >
