              ...
              >
                ...
                <div className="flex items-center gap-2 pt-1">
                  <label className="flex items-center gap-2 cursor-pointer group select-none">
                    ...
                    <input 
                      type="checkbox" 
                      checked={capture.posted}
                      onChange={() => togglePosted(capture.id, capture.posted)}
                      className="w-4 h-4 rounded border-[var(--border-hairline)] text-[var(--accent)] focus:ring-[var(--accent)] bg-[var(--bg-base)] cursor-pointer"
                    />
                  </label>
                </div>
              </div>
