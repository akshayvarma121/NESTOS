...
const schema = `
ALTER TABLE pos_routines ADD COLUMN IF NOT EXISTS description TEXT;
`;

async function initDb() {
  try {
    await client.connect();
    console.log("Connected to database. Applying Routine Description schema...");
    await client.query(schema);
    console.log("Routine Description schema applied successfully.");
